...
from harbor.memory.features import SemanticType, TokenRecord, classify_token_semantic
...
def build_token_records(
    ...
    from harbor.memory.features import tokenize_context_lines, synthesize_attention_mass
