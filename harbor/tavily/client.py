...
class DemoTavilyClient(TavilyClient):
    """Fixture-backed Tavily for `harbor doctor` and CI."""

    def search(self, query: str, **kwargs) -> TavilyBundle:
        from pathlib import Path

        fixture = Path(__file__).resolve().parent.parent.parent / "examples/demo_fixtures/tavily_search.json"
    ...
    def extract_urls(self, urls: List[str], query: Optional[str] = None) -> List[Dict[str, Any]]:
        ...
        fixture = Path(__file__).resolve().parent.parent.parent / "examples/demo_fixtures/tavily_extract.json"
        data = json.loads(fixture.read_text())
