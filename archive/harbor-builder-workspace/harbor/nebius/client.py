"""Nebius Token Factory — OpenAI-compatible inference for Harbor."""
...
class DemoNebiusClient(NebiusClient):
    ...
    def chat(
        ...
        *,
                            ...
                            "arguments": json.dumps(
                                {
                                    ...
                                    "description": "Auto-filed by Harbor morning brief",
                                }
                            ),
                        },
                    },
        ...
        summary = (
            "# Harbor Brief (demo inference via Nebius Token Factory stand-in)\n\n"
